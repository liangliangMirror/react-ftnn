    ...
    render() {
        return (
            <div className="recommendation">
                ...
                <p className="zan">
                    <span><em className="iconfont icon-like-fill" style={{fontSize:'16px',color:'#ffd2bb'}} /><em>8</em></span><span style={{float:'right'}}><em>2</em>评论·<em>10612</em>浏览</span>
                </p>
                <p className="discuss">
                ...
                <div className="interest">
                <p className="p"><span>感兴趣的股票</span><span><em className="iconfont icon-ellipsis" style={{fontSize:'24px'}} /></span></p>
                </div>
            </div>
        )
    }
